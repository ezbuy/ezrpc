...
// tmplGolangServerGogo reads file data from disk. It returns an error on failure.
func tmplGolangServerGogo() (*asset, error) {
	path := "/Users/wuvist/Desktop/65Daigou/ezrpc/src/github.com/ezbuy/ezrpc/tmpl/golang/server.gogo"
	name := "tmpl/golang/server.gogo"
